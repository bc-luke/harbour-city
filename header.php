                ...
                <header class="header">
                    ...
                    <div class="span8 header-links">
                        ...
                        <?php wp_nav_menu( array( 
                            ...
                            'items_wrap' => '<button type="button" class="btn btn-inverse btn-large btn-block visible-phone menu-toggle" data-toggle=".menu-primary">Menu</button><ul id="%1$s" class="%2$s">%3$s</ul>'
                        ) ); ?>
                    </div>
                </header>
            </div>
